...
import { DealCardButtons }          from './DealCardButtons';
import { DealInfoButton }           from './DealInfoButton';
...
class _DealListCard extends React.Component<Props, State> {
  private domRef: any;
  ...
  public render(): React.ReactNode {
    ...
    if (areDetailsExpanded) {
      void router.prefetch(CUSTOMER_COMPANY_ROUTES.dealDetailsPath);
    }
    ...
    return (
      <>
        ...
        <VisibilitySensor onChange={visible => {
          ...
          customerAnalyticsService.dealListImpression(
            {
              company,
              deal,
            },
            ...
            <Collapse in={areDetailsExpanded} timeout={{
              ...
              <div
                ...
                <CardContent
                  ...
                  <DealInfoButton company={company} deal={deal}/>
                </CardContent>

                <CardContent className={classes.detailsTableContentPadding} onClick={() => this.handleExpandClick()}>
                  <DealItemDetailsTable deal={deal} company={company}/>
                </CardContent>
              </div>
              <CardActions>
                <DealCardButtons deal={deal} company={company}/>
              </CardActions>
            </Collapse>
          </Card>
        </VisibilitySensor>
          ...
          <>
            ...
            <a /*Link for SEO*/
              ...
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                void pushRoute(CUSTOMER_COMPANY_ROUTES.dealDetailsPath, CUSTOMER_COMPANY_ROUTES.dealDetails, {
                  dealId:    deal.id,
                  companyId: company.id,
                });
              }}>MEHR</a>
  ...
  private handleExpandClick(flag = !this.state.areDetailsExpanded): void {
    ...
    if (flag) {
      ...
      customerAnalyticsService.dealCardExpanded(
        {
          company,
          deal,
        },
...
export const DealListCard = (withStyles(styles)(withRouter(_DealListCard)));
