...
import { NewsDetailCardButtons }      from './NewsDetailCardButtons';
...
class _NewsDetailCard extends React.Component<Props> {
      ...
      <>
        ...
        <div className={classes.root} onClick={() => window.history.back()}>
          <Card elevation={24} className={classes.card}>
            ...
            <CardActions>
              <NewsDetailCardButtons deal={deal} company={company}/>
            </CardActions>
          </Card>
        </div>
      </>
...
export const NewsDetailCard = withStyles(styles)(_NewsDetailCard);
