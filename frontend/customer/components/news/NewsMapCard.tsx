...
class _NewsMapCard extends React.PureComponent<Props> {
  ...
  private onClick(e: any): void {
    ...
    void pushRoute(CUSTOMER_COMPANY_ROUTES.newsDetailsPath,
                   CUSTOMER_COMPANY_ROUTES.newsDetails,
                   {
                     dealId:    deal.id,
  ...
  public render(): React.ReactNode {
    ...
    return (
      <VisibilitySensor onChange={visible => {
        ...
        customerAnalyticsService.newsMapImpression({
                                                     company,
                                                     deal,
                                                   });
      }}
...
export const NewsMapCard = (withStyles(styles)(_NewsMapCard));
