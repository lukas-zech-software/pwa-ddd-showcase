...
class _StockImages extends PureComponent<Props, State> {
  ...
  public async componentDidMount(): Promise<void> {
    try {
      const images = await dashboardCompanyFacade.getStockImages();
      if (images === undefined) {
        throw new Error('No stock images found');
      }
      this.setState({ images });
    } catch (error) {
      logService.error('Error fetching stock images', error);
...
export const StockImages = withStyles(styles)(_StockImages);
